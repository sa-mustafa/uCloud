...
namespace Bps.uCloud.API.Filters
{
    /// <summary>
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            foreach (var par in pars)
            {
                ...
                if (attributes != null && attributes.Count() > 0 && swaggerParam != null)
                {
                    ...
                    if (rangeAttr != null)
                    {
                        decimal rangeMin = Convert.ToDecimal(rangeAttr.ConstructorArguments[0].Value);
                        decimal rangeMax = Convert.ToDecimal(rangeAttr.ConstructorArguments[1].Value);
